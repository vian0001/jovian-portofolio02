...
document.addEventListener('DOMContentLoaded', () => {
    ...
    projectCards.forEach(card => {
        card.addEventListener('click', (e) => {
            // Don't trigger if clicking on the filter buttons or other interactive elements inside (if any)
            if (e.target.closest('.project-filters')) return;
    ...
    // Click outside to close active cards
